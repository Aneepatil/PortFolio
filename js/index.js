...
const introImgContainer=document.querySelector('.introImgContainer')
...
for(i=1;i<=365;i++){
    ...
    element.classList=list.includes(i)? 'active box' :' box'
...
window.addEventListener("scroll", ()=>{
    ...
    introTextContainer.style.transform=`translateY(${offsetY * 0.2}px)`
    introImgContainer.style.transform=`translate(${offsetY * 0.5}px,${-offsetY * 0.5}px)`
    ...
    projectTitle.style.transform = `translateY(calc(420vh - ${offsetY}px))`
